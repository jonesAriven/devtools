...
| 2026-09-10 | ADR-2026-09-10 · 平台重构 Phase 0 清死代码 + kb-auth 残留清理 | 执行中（方案与核实 100%，代码改动待新会话按 §7 清单执行；工作区已恢复干净基线） | cross-project | `/root/devtools/docs/adr/ADR-2026-09-10-平台重构Phase0清死代码.md` |
