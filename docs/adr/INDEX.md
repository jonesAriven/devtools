...
| 日期 | ADR | 状态 | 归属 | 位置 |
|---|---|---|---|---|
|  | ADR-2026-08-05 · workcheck_python 部署与流水线 | 已实施 | cross-project | `/root/hermes-workspace/adr/workcheck-python-deployment.md` |
| 2026-07-18 | ADR-2026-07-18 · Woodpecker 流水线提速优化 | 已实施 | infrastructure | `/root/hermes-workspace/adr/infrastructure/ADR-2026-07-18-woodpecker-speedup.md` |
...
| 2026-07-26 | ADR-2026-07-26 · Nexus 全量包缓存预热拉取 | 已实施 | infrastructure | `/root/hermes-workspace/adr/infrastructure/ADR-2026-07-26-nexus-cache-prewarm.md` |
...
| 2026-09-10 | ADR-2026-09-10 · 平台重构 Phase 0 清死代码 + kb-auth 残留清理 | ✅ 已完成（commit `a968bd0` 已双推；三应用编译通过；未触发流水线；遗留项见 §12.5） | cross-project | `/root/devtools/docs/adr/ADR-2026-09-10-平台重构Phase0清死代码.md` |
