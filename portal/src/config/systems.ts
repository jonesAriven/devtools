...
export const systems: SystemConfig[] = [
  // ========== Web 系统 ==========
  {
    ...
    healthCheckUrl: 'https://tools.marschat.online/kb/api/auth/actuator/health',
    icon: 'Reading',
    color: '#409eff',
    techStack: 'Spring Boot 3.2 + Vue3 + MySQL + MongoDB + MinIO + MeiliSearch',
    docs: [
      { label: '产品文档', url: 'https://tools.marschat.online/kb/#/dashboard' },
      { label: '部署方案', url: 'https://tools.marschat.online/kb/' },
    ],
  },
  {
    id: 'activation-code',
    ...
    category: 'web',
    url: 'https://tools-test.marschat.online',
    healthCheckUrl: 'https://tools-test.marschat.online/actuator/health',
    icon: 'Key',
    color: '#e6a23c',
    techStack: 'Spring Boot 3.4 + Java 21 + MyBatis-Plus + MySQL',
    docs: [
      { label: '设计文档', url: 'https://tools-test.marschat.online' },
    ],
  },
  {
    id: 'nexus',
  ...
  },
  {
    ...
    category: 'infra',
    url: 'http://192.168.31.105:8084/kb-ops/',
    healthCheckUrl: 'http://192.168.31.105:8084/kb-ops/actuator/health',
    icon: 'SetUp',
    color: '#9c27b0',
