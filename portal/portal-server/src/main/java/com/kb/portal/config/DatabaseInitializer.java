...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    private void initData() {
        ...
        List<Object[]> systems = Arrays.asList(
            ...
            new Object[]{"QRCodeTool (C#)", "二维码扫描与生成工具，已接入激活码验证体系", null, "Aim", "#9c27b0", "tool", 1, null, "[{\"label\":\"使用说明\",\"url\":\"https://kb.marschat.online/kb/\"}]", "/portal/downloads/QRCodeTool.zip", "C# .NET 6 WinForms", 7},
