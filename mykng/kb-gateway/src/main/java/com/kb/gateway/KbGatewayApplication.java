 ...
 * 注意：不扫描 com.marschat.common 下的 servlet 相关配置（TraceIdAutoConfig、GlobalExceptionHandler），
 * 因此不会与 WebFlux 冲突；仅复用 {@code com.marschat.common.result.Result} 用于统一错误响应。
 */
