...
- **描述**：开发环境（最小化启动）
- **服务模块**：`kb-gateway`, `auth-center`, `kb-knowledge`
...
- **描述**：测试环境（核心功能验证）
- **服务模块**：`kb-gateway`, `auth-center`, `kb-file`, `kb-knowledge`, `kb-intelligence`
...
graph TD
    ...
    %% ===== 网关层 ===== %%
    Gateway -->|lb://| Auth[统一认证中心<br/>auth-center:8085]
