...
import { setToken, setRefreshToken, getRefreshToken, setTokenKind } from '@/utils/token'

const STATE_KEY = 'infra_sso_state'
const VERIFIER_KEY = 'infra_sso_verifier'
const REDIRECT_KEY = 'infra_sso_redirect'
